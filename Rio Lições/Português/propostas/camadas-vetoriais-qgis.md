...
Abra o ficheiro que você salvou no final da lição [instalar o QGIS 2.0 e adicionar camadas](https://programminghistorian.org/en/lessons/qgis-layers). Deve ter as seguintes camadas na aba 'Camadas':
