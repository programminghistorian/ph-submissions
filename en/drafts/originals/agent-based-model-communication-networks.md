...
```python id="XpIUqiPbeond"
model = LetterModel(50, 10, 10)
for i in range(100):
    model.step()
```

<!-- #region id="hwgNP7LLeond" -->
...
```python id="khys9CSceonh"
agent_letters.to_csv("agent_data.csv")
```

<!-- #region id="gX-SOn1keonf" -->
> _Bonus question 4_:
