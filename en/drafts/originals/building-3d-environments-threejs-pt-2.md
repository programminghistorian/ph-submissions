...
If you visit the served website (generally http://localhost:3000 but check the address given in the terminal), you should be back to an empty scene with a peach background.

You might have noticed that the pots in the model of Part 1 were different colours. These colours relate solely to what techniques were used to make the pot. To communicate these techniques to the website viewer, you will construct a key featuring a plane and coloured spheres. 
