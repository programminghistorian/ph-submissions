...
{% include figure.html filename="or-en-designing-a-timeline-tabletop-simulator-08.png" alt="Two pages of cards in a grid format. The right and left pages almost mirror each other, but the left hand set of cards have years printed in bold and the right hand set of cards do not." caption="Figure 8: Two pages generated by nanDECK for printing. Note that the pages are oriented so that they can be folded together to make matched, double-sided cards." %}
...
{% include figure.html filename="or-en-designing-a-timeline-tabletop-simulator-09.png" alt="A screenshot of Tabletop Simulator that features an image of an octagon-shaped wooden table obscured by Timeline cards falling through the air." caption="Figure 9. While one of the most delightful features of Tabletop Simulator is the ability to flip the table, throwing cards around is also pretty enjoyable." %}
