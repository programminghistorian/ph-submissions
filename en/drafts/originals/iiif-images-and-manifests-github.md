...
| **Cons**<br><br>- No batch processing or editing (images must be uploaded one by one)<br>- No control over image processing or the resulting image<br>- No deep zoom or image display specifications | **Cons**<br><br>- Limited control over image processing<br>- Can be buggy<br>- File size restrictions for the tiler to function | **Cons**<br><br>- No visual editor/interface<br>- Requires a **strong** grasp of the command line<br>- Requires knowledge of editing JSON files |
