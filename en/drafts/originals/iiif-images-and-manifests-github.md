...
|----------|----------|----------|
| **Pros**<br><br><ul><li>Visual editor/interface</li><li>No programming or command-line knowledge required</li><li>No experience editing JSON files required</li></ul> | **Pros**<br><br><ul><li>Easy-to-use graphical interface</li><li>Some control over image processing and the resulting image or manifest specifications</li></ul> | **Pros**<br><br><ul><li>Batch processing and editing (hundreds of images at once)</li><li>High level of control over image processing and the resulting image or manifest specifications</li></ul> |
| **Cons**<br><br><ul><li>No batch processing or editing (images must be uploaded one by one)</li><li>No control over image processing or the resulting image</li><li>No deep zoom or image display specifications</li></ul> | **Cons**<br><br><ul><li>Limited control over image processing</li><li>Can be buggy</li><li>File size restrictions for the tiler to function</li></ul> | **Cons**<br><br><ul><li>No visual editor/interface</li><li>Requires a strong grasp of the command line</li><li>Requires knowledge of editing JSON files</li></ul> |
