...
| Cons:<br>- No batch processing or editing (must upload one-by-one)<br>- No control over processing or the resulting image <br>-No deep zoom or image display specifications | Cons:<br>- Limited control over image processing <br>- Can be buggy <br>- Images must be smaller | Cons:<br>- No visual editor/interface<br>- Requires **strong** grasp of command line<br>- Requires knowledge of editing JSON files                                         |
|                                                                                                                                                      |                                                                                                                                                               |                                                                                                                                                                        |
