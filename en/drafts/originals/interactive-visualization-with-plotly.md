...
<p class="plotly-caption" style="text-align: center; margin-top: 0.5rem; font-family: 'Open Sans'; font-size: 0.8em;">Caption with <a href="https://github.com/programminghistorian/ph-submissions/blob/gh-pages/assets/interactive-visualization-with-plotly/interactive-visualization-with-plotly-01.html" target="_blank">link</a>.</p>
