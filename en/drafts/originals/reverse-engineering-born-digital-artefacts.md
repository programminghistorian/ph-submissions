...
This pervasive opaqueness creates significant barriers for historians and archivists studying born-digital artifacts. Researchers cannot inspect how digital artifacts were produced or operate internally, encountering only outward behaviors rather than underlying mechanisms. As a preservation report notes, proprietary software systems present a conflict because *"it's a black box that cannot be opened"*.[^4] Closed-source programs are not fundamentally auditable by outsiders. Without access to source code or technical documentation, the internal data structures, algorithms, and dependencies remain invisible, which *"hamper(s) (or mak(es) impossible) new discoveries"* about the artifact's creation and context.[^5] The closed nature of consumer computing technology severely limits direct historical analysis of digital content.
...
![Schematic visualization of a computer's hardware and software layers.](en-or-reverse-engineering-born-digital-artefacts-01.png)
...
In the realm of software, reverse engineering became essential for compatibility and interoperability. One of the most significant milestones in this regard was the development of Linux, where reverse engineering played a pivotal role in making the operating system compatible with a wide range of hardware and existing software. Without direct access to proprietary documentation, developers used reverse engineering to analyse how drivers and system calls functioned to implement open-source equivalents. This process not only allowed Linux to run on a broad spectrum of hardware platforms but also spurred innovation in open-source software development.

Reverse engineering has also been deeply intertwined with video game culture. Enthusiasts and hackers have long engaged in reverse engineering to modify games, create new levels, and uncover hidden features. This has been particularly influential in game modding communities, where players have reversed compiled code to customize game mechanics and extend gameplay. In some cases, reverse engineering has allowed players to port games to new platforms or restore functionality after official support ended. The modding and hacking communities have essentially become part of the preservation effort, treating games as digital artifacts worthy of study and preservation.

Reverse engineering has also become a fundamental tool in the field of cybersecurity, particularly in malware analysis. Malicious software (malware) is often designed to conceal its true function and evade detection. A notable historical example is the analysis of the Stuxnet worm, discovered in 2010. Stuxnet was a highly sophisticated piece of malware designed to target industrial control systems, specifically Iran’s nuclear program. Reverse engineers discovered that Stuxnet exploited previously unknown vulnerabilities and used complex techniques to remain hidden while sabotaging centrifuges. The discovery and analysis of Stuxnet highlighted the strategic importance of reverse engineering in national security and cyber warfare.

The importance of reverse engineering in malware analysis reflects its broader historical significance as a tool for both technological innovation and security. By uncovering hidden vulnerabilities and understanding the tactics of malicious actors, reverse engineers contribute to strengthening digital infrastructure and protecting sensitive data.
...
![Infographic annotating a JPEG's file header in hexadecimal notation. (CC-BY 4.0) 2022 Ange Albertini](en-or-reverse-engineering-born-digital-artefacts-02.png)
...
![A cat sitting on a couch](en-or-reverse-engineering-born-digital-artefacts-03.jpeg)
...
![Clean version’s ‘summer games’ file content, produced with C64-Tools.](en-or-reverse-engineering-born-digital-artefacts-04.png)

![SCA cracked version’s ‘summer games’ file content, provided by the SCA website.](en-or-reverse-engineering-born-digital-artefacts-05.png)
...
[^3]:  Victoria and Albert Museum. “Preserving and Sharing Born Digital and Hybrid Objects · V\&A.” Accessed April 22, 2025. [https://www.vam.ac.uk/research/projects/preserving-and-sharing-born-digital-and-hybrid-objects](https://www.vam.ac.uk/research/projects/preserving-and-sharing-born-digital-and-hybrid-objects).

[^4]:  Stallman, Richard, and Richard M. Stallman. *Free Software, Free Society: Selected Essays*. Edited by Joshua Gay. 1st. ed. Boston, Mass: Free Software Foundation, 2002, S.50.
