...
Like an archaeologist brushing away layers of sediment, the digital historian uses reverse engineering to uncover the buried architecture of software and file formats. This method allows researchers to move beyond the visible interface and into the structural, functional, and contextual elements of digital artifacts—essential for overcoming the limitations of screen essentialism, where sources are interpreted solely based on what they display. This approach aligns with the multi-layered perspective of digital source criticism, emphasizing that digital objects are not isolated but embedded in broader technological and socio-economic systems.

Digital files—from video games and databases to image formats and malware—contain layers of information not visible in standard interfaces. Reverse engineering helps expose those layers. By investigating how a file is constructed, how it behaves when manipulated, or what metadata it stores, historians can recover undocumented data, trace software evolution, and reconstruct the conditions under which artifacts were created or used. This is especially relevant when dealing with closed-source systems. Reverse engineering becomes one of the few viable methods to “write the missing manual” and investigate digital heritage without access to original documentation or source code.

File structures and formats are especially interesting from a historical malware research perspective. One of the first computer viruses discovered in the wild, the Elk Cloner virus spread by attaching itself to a disk’s boot sector and activated whenever the infected disk was inserted into an Apple II computer.[^13] Around the same time, in early hacking culture, steganography — the art of hiding code or messages in images — also became a popular topic on message boards.[^14] If you want to dive deeper into file structures and formats, check out the work of Ange Albertini, a well-known security researcher who explores unusual file formats. His Corkami project offers a comprehensive collection of hex patterns that illustrate various file format structures and anomalies, serving as a valuable reference for understanding the binary composition of different file types. For us digital Historians, it is essential to understand digital media artifacts as a structured or sometimes seemingly unstructured pile of binary data. One of the first jobs we do is to try to understand the underlying structure of those files. Engaging with resources like the Corkami project can deepen your understanding of file formats and uncover the hidden complexities within digital files, enhancing your skills in reverse engineering and digital archaeology.​ 
