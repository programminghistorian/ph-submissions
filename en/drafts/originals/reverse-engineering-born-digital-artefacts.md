...
This lesson is a hands-on tutorial that introduces transferable analytical practices for working with born-digital artefacts. At the end of this lesson, you will be able to:

- Explain what reverse engineering is and how it can be used to analyze born-digital artefacts for historical research.
...
All JPEG files follow this general architecture, and this predictable structure is what allows software to recognize and “parse” (interpret) the data correctly. The infographic below provides a visual breakdown of this structure in JPEG files. You do not need to memorize every byte; rather, you can use this as an introduction to the structural markers that allow you to inspect a digital artefact.
...
In 2007, however, the nature of the artefact changed when Microsoft Word transitioned to the `.docx` format as its default file format. If you compare the hex data of a `.doc` file to a `.docx` file, you will see that the two formats have very different internal structures. To inspect the provided `.docx` file, run:
...
[^7]: Henry Jenkins. “A New ‘Platform’ for Games Research?: An Interview with Ian Bogost and Nick Montfort (Part One) — Pop Junctions,” April 27, 2009. <http://henryjenkins.org/blog/2009/04/an_interview_with_ian_bogost_a.html>.
