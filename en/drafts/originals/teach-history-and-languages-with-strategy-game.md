...
In this intermediate-level lesson, I presume some experience with installing software and playing computer games. As you progress, you will learn how to use the hackable [sandbox](https://en.wikipedia.org/wiki/Sandbox_game) that is 0 A.D. to help you teach history and languages. Since your students will need some onboarding with 0 A.D., it is advisable to implement this lesson when you and your students are able to learn side-by-side.
...
You may now play your custom historical scenario, either as a singleplayer or multiplayer game. If this is the first time that you have set up a game in 0 A.D., I recommend that you read the [Setting up a game](https://gitea.wildfiregames.com/0ad/0ad/wiki/Manual_SettingUpAGame) Wiki article. For classroom usage, the [Hosting / Joining a Multiplayer game](https://gitea.wildfiregames.com/0ad/0ad/wiki/Manual_SettingUpAGame#hosting--joining-a-multiplayer-game) sub-section will be most important.
