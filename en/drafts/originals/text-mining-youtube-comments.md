...
{% include figure.html filename="en-or-text-mining-youtube-comments-04.png" alt="Screenshot of the four files generated by YouTube Data Tools. We've highlighted the two files which will be used in this tutorial's code: 'authors' and 'comments'." caption="Figure 4. The four files generated by YouTube Data Tools" %}

The video ID follows immediately after the phrase "videoinfo." The download date (the date the files were generated and downloaded), immediately follows the video ID.
