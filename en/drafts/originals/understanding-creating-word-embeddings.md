...
When was the astronomical concept of orbital 'revolution' supplanted by political uprising? How do popular methods for cooking chicken change over time? How do associations of words like 'grace' or 'love' vary between prayers and romance novels? Humanistic inquiries such as these that can prove to be challenging to answer through traditional methods like close reading.
...
This lesson will have a more theoretical focus. It will explore how word vectors work, how to interpret them, and how to prepare a corpus for training a model. The lesson will provide some introductory code to get you started with word vectors, but the main focus of the lesson will be developing core concepts and an understanding of the functionality and methodology of word vectors.
