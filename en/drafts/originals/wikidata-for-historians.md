...
While there is (probably) general consensus on the meaning of 'date of birth,' most concepts are not so clear cut. Take, for example, 'head of state'([Q48352](https://www.wikidata.org/wiki/Q48352)), which was used in the age query above to identify Abdel Nasser and his counterparts in other countries. But Wikidata also contains an item labeled 'head of government'([Q2285706](https://www.wikidata.org/wiki/Q2285706)). Perhaps we ought to have used this instead? 

Let's take a closer look at 'head of state' and 'head of government.' Now is the time to introduce a new concept: **class**. This meaning of 'class' is different from the 'class' of 'class struggle.' As mentioned earlier, Wikidata is one of the world's great disambiguation resources, positively distinguishing between at least five kinds of class: [Q16889133](https://www.wikidata.org/wiki/Q16889133), [Q187588](https://www.wikidata.org/wiki/Q187588), [Q37517](https://www.wikidata.org/wiki/Q37517), [Q18204](https://www.wikidata.org/wiki/Q18204) and [Q217594](https://www.wikidata.org/wiki/Q217594). In database ontology, '[class]'(https://en.wikipedia.org/wiki/Class_(knowledge_representation))([Q16889133](https://www.wikidata.org/wiki/Q16889133)) is a logical term used to organize concepts in a data structure. 
