...
Let's take a closer look at "head of state" and "head of government." Now is the time to introduce a concept that may be new to most historians: **class**. Let's disambiguate this meaning of "class" from the "class" of "class struggle," though![^5] In database ontology, [class](https://en.wikipedia.org/wiki/Class_(knowledge_representation)) is a logical term organizing concepts in a data structure. 
