...
Then, we will go to the **Model** tab in order to define our data model. To start, we will add an object type by clicking on the *Add Object Type* tab. In our conceptual model, we have already defined our three object types: the work, the author, and the publishing house.
