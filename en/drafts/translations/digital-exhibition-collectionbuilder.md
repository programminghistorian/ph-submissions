...
{% include figure.html filename="en-tr-digital-exhibition-collectionbuilder-6-live-site.png” alt="Screenshot of the message you will receive when your site is live.
" caption="Figure 6: Screenshot of the message you will receive when your site is live.
" %}
...
{% include figure.html filename="en-tr-digital-exhibition-collectionbuilder-7-commits.png” alt="Screenshot of GitHub demo repository page with a yellow circle around the Commits link, which you can use to check the status of your commits.
" caption="Figure 7: Screenshot of GitHub demo repository page with a yellow circle around the Commits link, which you can use to check the status of your commits.
" %}
