...
You have probably already heard about metadata, open data, and linked open data. However, before starting this lesson, it's important to clarify and deepen our understanding of these concepts and briefly explore their interconnections, with the aim of consolidating our comprehension.

The prefix "meta" comes from Greek, in which it means "after" or "beyond." So, abstractly, we use it to indicate that a concept applies to itself. The word "metadata," therefore, would be something like "data that talks about data," in the sense that it describes, identifies, locates, or facilitates the understanding of the data. Especially in the interdisciplinary field of information science, metadata provides context and structure, allowing efficient management, search, and organization of information, as well as facilitating interoperability between systems, different platforms, and the long-term preservation of digital resources. Today, with the Internet, metadata is increasingly used due to the enormous amount of information available online, as it is essential to facilitate web pages classification, optimize search engines, and improve user navigation.[^1] [^2] [^3]

Latetly, in an increasingly digitized and connected world, interest in open data has grown exponentially, given the need to promote transparency and their reuse in various disciplines. Increasingly, metadata is made available with the necessary technical and legal characteristics so that it can be freely used, reused, and redistributed by anyone, at any time and in any place, from scientific research to the management of cultural resources.[^4] The adoption of open standards for metadata not only facilitates the understanding and exchange of data but also drives innovation by allowing everything to communicate more effectively. In this context, open data has become an essential component for building sustainable and accessible data infrastructures, promoting a collaborative approach to information management in the digital era.

Within this open data framework, a way of presenting and publishing data on the web has emerged so that they can be consumed and reused anywhere and through automated processes: linked open data (LOD). From now on, we will use the acronym LOD to refer to this concept. The origin of LOD goes back to a principle that manifests the power to establish meaningful links between data with similar attributes that are available in different web sources, which implies the establishment of an environment with global interoperability.[^5] Therefore, this term refers to a set of best practices for publishing and connecting structured data on the web. As a novel and different approach from others, information in Wikidata is stored in semantic triples [^6] following the Resource Description Framework (RDF), which are conventionally known as subject, predicate, and object. If you still have doubts or want to deepen your knowledge on this topic, you can consult more details in [Jonathan Blaney's lesson](https://programminghistorian.org/en/lessons/intro-to-linked-data), which offers a brief and concise introduction to linked open data.

This lesson shows you how to create, edit, and publish LOD in a simple and free way through the use of Wikidata. You will learn about the structure of Wikidata and the procedures for creating, editing, and publishing LOD related to entities in the academic and research world: scientific journals and researchers. The lesson is primarily aimed at librarians, archivists, and other information professionals working in the academic context who wish to increase the visibility of the knowledge produced at their institution.
