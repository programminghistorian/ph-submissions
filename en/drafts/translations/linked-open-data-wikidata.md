...
One helpful tool for creating and editing entities is Recoin (Relative Completeness Indicator) (see Figure 18), which displays a list of relevant properties that could be added to an entity’s page. This is especially useful for new users who may not yet be familiar with Wikidata’s properties.
