...
Como vemos, en ambos criterios trabajamos solo con los personajes que intervienen verbalmente en la obras, a pesar de que con el criterio de coaparición en escena sí podríamos tener en cuenta también a los personajes que están presentes pero no hablan. Sin embargo, esto a veces no es fácil de determinar con la lectura del texto y es durante el montaje de la representación que se acuerda qué personajes están sobre el escenario y quienes no. Además, cuando se realizan ARS de personajes utilizando métodos de extracción automática se suele hacer a través de la anotación de las intervenciones de personajes, por ejemplo con un XML-TEI y la etiqueta <speaker>. Por esta razón, y para tratar de que nuestros análisis puedan compararse con los de otras personas, lo mejor es centrarse solo en los personajes que sí hablan.
...
[^7] También puedes utilizar la plantilla que he preparado: https://docs.google.com/spreadsheets/d/1_RCqlJ8epD9S29dCySgYlOCZpOIKaVMzelgv0dyd64g/. Y si prefieres no usar Google Spreadsheets, desde ese enlace puedes descargar el archivo tanto para Microsoft Excel (.xlsx) como para LibreOffice Calc (.ods). 
