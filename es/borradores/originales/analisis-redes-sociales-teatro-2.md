...
Si te diriges al **Laboratorio de datos**, verás que se han añadido varias columnas más en la tabla de nodos, ahora con los resultados de las *medidas de centralidad*. La *centralidad* en ARS tiene que ver con el lugar que ocupan los nodos en el conjunto de una red y nos ayudan a entender la *importancia* de los nodos dentro del sistema que analizamos[^5]. Estas son algunas de las medidas de centralidad, pero hay unas cuantas más:
...
{% include figure.html filename="ars-teatro-2_21.png" caption="Gráfico comparativo del grado con pesos normalizado de los primeros galanes y primeras damas de ocho comedias del siglo de oro" %}
