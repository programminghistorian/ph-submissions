...
Por ejemplo, en la comedia con la que estamos trabajando, *Las bizarrías de Belisa*, ningún personaje tiene una centralidad de intermediación normalizada demadiado alta. No hay ningún nodo que eliminándolo provoque un *grafo disconexo*, es decir que ciertos nodos quedan desconectados del núcleo principal.  

Siguiendo en el cuadro de "Estadísticas" nos encontramos la "Densidad". La [*densidad*](https://es.wikipedia.org/wiki/Densidad_(teor%C3%ADa_de_grafos)) mide el nivel de conectividad entre todos los nodos de un grafo. Por ejemplo, un grafo tendría una densidad del 100% cuando todos los nodos están conectados entre sí. Matemáticamente la densidad se calcula a través de la proporción de aristas que tiene una red frente al total de aristas posibles, expresado el resultado en un rango [0,1]: cerca de 1 se dice que es un grafo *denso*; cunato más cerca de 0 se habla de un grafo *disperso*. Haz clic en "Ejecutar":
