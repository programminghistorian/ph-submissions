...
**¡Atención!** El hash que ves tras `integrity=` cambiará con otras versiones de Leaflet. Deberás comprobar el modo de cargar desde un servidor externo cuando lo programes. Esta opción no es la recomendada.
