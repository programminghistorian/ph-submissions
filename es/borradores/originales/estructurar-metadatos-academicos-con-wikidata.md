...
Otra propiedad muy común en la descripción de personas es el [“campo de trabajo” (P101)](https://www.wikidata.org/wiki/Property:P101). Esta propiedad permite designar la especialización o campo de estudio de una persona u organización. Se pueden registrar todos los valores que sean necesarios para describir adecuadamente los campos del saber o de actividad en los que se destaca una persona.
