...
Para esta lección preparamos previamente cinco imágenes por cada una de las secciones. Es decir, nuestra gramática visual tendrá cinco opciones para escoger en la composición por cada una de las secciones definidas. Para seguir la lección, descarga las imágenes en [este enlace](/assets/generadores-aventura/imgs). Crea una carpeta llamada `imgs` en la carpeta de tu proyecto, y luego copia y pega todas las carpetas de imágenes en la carpeta `imgs`.
