...
{% include figure.html filename="generadores-aventura3.png" alt="Captura de pantalla de la interfaz de github que indica el lugar donde se encuentra el enlace a losm lanzamientos o "releases" de la librería: la columna derecha, justo debajo de la palabra releases" caption="El enlace a los lanzamientos o "releases" de la librería" %}
