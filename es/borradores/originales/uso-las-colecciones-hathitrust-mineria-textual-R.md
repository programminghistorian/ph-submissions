...
{% include figure.html filename="es-or-uso-las-colecciones-hathitrust-mineria-textual-R-07.png" alt="Menú en todas las páginas para ir a las colecciones" caption="Figura 5. Menú para ver las colecciones" %}
...
{% include figure.html filename="es-or-uso-las-colecciones-hathitrust-mineria-textual-R-05.png" alt="La página para crear tus propias colecciones en HathiTrust" caption="Figura 6. Nueva colección" %}
...
{% include figure.html filename="es-or-uso-las-colecciones-hathitrust-mineria-textual-R-06.png" alt="Información sobre la novela de Jorge Icaza" caption="Figure 7. Huasipungo de Jorge Icaza" %}
