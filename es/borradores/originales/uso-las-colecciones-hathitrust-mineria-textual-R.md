...
{% include figure.html filename="es-or-uso-las-colecciones-hathitrust-mineria-textual-R-05.png" alt="Visual description of figure image" caption="Figura 5. Caption text to display" %}
...
{% include figure.html filename="es-or-uso-las-colecciones-hathitrust-mineria-textual-R-06.png" alt="Visual description of figure image" caption="Figura 6. Caption text to display" %}
...
{% include figure.html filename="es-or-uso-las-colecciones-hathitrust-mineria-textual-R-07.png" alt="Visual description of figure image" caption="Figura 7. Caption text to display" %}
...
{% include figure.html filename="es-or-uso-las-colecciones-hathitrust-mineria-textual-R-08.png" alt="Visual description of figure image" caption="Figura 8. Caption text to display" %}
