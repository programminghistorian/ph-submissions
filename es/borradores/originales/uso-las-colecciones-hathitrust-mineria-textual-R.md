...
{% include figure.html filename="es-or-uso-las-colecciones-hathitrust-mineria-textual-R-07.png" alt="Menú para ir a las colecciones" caption="Figura 7. Caption text to display" %}
...
{% include figure.html filename="es-or-uso-las-colecciones-hathitrust-mineria-textual-R-08.png" alt="Ejemplo de un volumen añadido a la colección creada" caption="Figura 8. Caption text to display" %}
