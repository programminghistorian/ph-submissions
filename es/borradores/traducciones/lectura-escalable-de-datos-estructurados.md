...
2. Usando la [Beginner's Guide to Twitter Data](/en/lessons/beginners-guide-to-twitter-data) de _Programming Historian_ (en inglés). En lugar de elegir CSV como formato de "output", elige JSON.
