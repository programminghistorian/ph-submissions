...
[Map Warper](http://mapwarper.net/), es una herramienta de código abierto, acceso libre y uso ilimitado, desarrollada y soportada desde 2008 por [Tim Waters](https://thinkwhere.wordpress.com/). Map Warper es utilizada en distintos centros de documentación, en proyectos de digitales y por profesionales o técnicos no especializados en el campo de la geografía, para georreferenciar y visualizar imágenes de áreas geográficas sin necesidad de instalar o comprar un programa informático. La herramienta fue diseñada para georreferenciar mapas antiguos -mapamundis, portulanos, cartas náuticas, planos topográficos, planos arquitectónicos, cartas geográficas-, fotografías aéreas y demás materiales que registran la colecciones cartográficas de caracter patrimonial. A su vez, la herramienta posibilita la vinculación del material georreferenciado a toda clase de sistemas de información geográfico (QGIS, JOSM, ArcGIS, Google Earth, World Map, otros), catálogos y motores de búsqueda automatizados. 

Gracias a sus características, la herramienta útil tanto para investigadores, profesores y estudiantes, como para las instituciones que estén desarrollando procesos de digitalización de patrimonio cartográfico o proyectos de humanidades espaciales, como son los caso del proyecto [Mapoteca Digital](http://bibliotecanacional.gov.co/es-co/colecciones/biblioteca-digital/mapoteca) de la Biblioteca Nacional de Colombia, [Cartografía de Bogotá](http://cartografia.bogotaendocumentos.com/) de la Universidad Nacional de Colombia y [Paisajes coloniales: redibujando los territorios andinos en el siglo XVII](https://historia.uniandes.edu.co/index.php/mapa-paisajes-coloniales) de la Universidad de los Andes. Además, Map Warper ayuda a descentralizar y agilizar los procesos de georreferenciación y catalogación, ya que su plataforma crea un espacio virtual de colaboración abierta.  

En este escenario, la lección se concibe como el primer componente de un módulo más amplio orientado al manejo de herramientas digitales para extraer y organizar de forma sistemática la información geoespacial contenida en los mapas antiguos.  
