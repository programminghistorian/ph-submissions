...
{% include figure.html filename="/images/reutilizando-colecciones-digitales-glam-labs/map-labs.png" caption="Mapa que representa las instituciones de la comunidad GLAM Labs" %}
