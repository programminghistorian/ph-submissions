...
En esta lección te hemos ofrecido el punto de partida que te permite ralizar procesos analíticos de datos y variables. En el caso revisado en esta lección, hemos trabajado con una problemática que implica cruzar tan sólo un par de variables. Como desafío, y a partir de lo que aprendiste en este tutorial, te proponemos que continúes probando variantes. Finalmente, te inviatamos a que te animes a trabajar directamente con a la fuente (https://gganimate.com/index.html) y descubrir por ti mismo la potencia de *ggplot* y *gganimate*.
