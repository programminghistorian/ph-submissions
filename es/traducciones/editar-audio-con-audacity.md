...
La interfaz cargará y reflejará los archivos cargados:
...
Para asegurar transiciones suaves entre las pistas, debemos introducir efectos de fundido o transiciones graduales en amplitud. Es  buena idea incluir un pequeño desvanecimiento de entrada (fade in) al comienzo de la pista y un desvanecimiento de salida (fade out) al final que lleve al silencio. Hacerlo puede prevenir fallos y ruidos al evitar que el sonido aparezca y desaparezca súbitamente.  
