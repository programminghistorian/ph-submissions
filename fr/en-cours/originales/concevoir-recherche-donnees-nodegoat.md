...
{% include figure.html filename="nodegoat-03.png" caption="Figure 3: Modèle de données avec objets, attributs et relations." %} 
...
{% include figure.html filename="nodegoat-04.png" caption="Figure 4: Le domaine de nodegoat encore vide." %} 
...
{% include figure.html filename="nodegoat-05.png" caption="Figure 5: Le volet Model et l'option qui nous permet de commencer à définir notre modèle de données." %} 
...
{% include figure.html filename="nodegoat-09.png" caption="Figure 9: Volet Management permettant de gérer le projet et de choisir quels objets seront utilisés." %} 
...
{% include figure.html filename="nodegoat-10.png" caption="Figure 10: Action pour connecter les objets à travers leurs attributs à travers l'option Reference: Object Type." %}
...
{% include figure.html filename="nodegoat-11.png" caption="Figure 11: Attribut « Date de fondation » comme Description." %}
...
{% include figure.html filename="nodegoat-12.png" caption="Figure 12: Création d’un sous-objet Chronology pour le Type « Maisons d’édition »." %}
...
{% include figure.html filename="nodegoat-13.png" caption="Figure 13: Visualisation de notre modèle de données sur nodegoat." %}
...
{% include figure.html filename="nodegoat-14.png" caption="Figure 14: Création d’une chronologie." %}

{% include figure.html filename="nodegoat-15.png" caption="Figure 15: Exemple de chronologie définie comme période « entre déclarations »." %}
...
{% include figure.html filename="nodegoat-16.png" caption="Figure 16: Aperçu des ouvrages sur notre base de données." %}


{% include figure.html filename="nodegoat-17.png" caption="Figure 17: Aperçu des auteurs sur notre base de données." %}
...
{% include figure.html filename="nodegoat-18.png" caption="Figure 18: Visualisation géographique des villes de naissance de nos auteurs sur nodegoat." %}
