...
Pour l’instant, cet outil nous suffit car nous n'y conservons qu'une quantité peu conséquente d’information. Mais imaginons que, au fur et à mesure que nous approfondissons notre enquête, nous questionnions de plus en plus les ouvrages et les auteurs. Ainsi, nous multiplirions les informations enregistrées. Nous pourrions, par exemple, élargir le tableau comme suit&nbsp;:
