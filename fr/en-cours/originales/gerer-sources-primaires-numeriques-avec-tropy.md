...
Notons-le d'emblée, les jeux de données proposés dans cette section ne sont pas nécessaires pour réaliser la leçon, sauf si vous préférez les utiliser à la place [du jeu de données principal](#les-affiches-du-printemps-érable). 
...
Enfin, dernier mais non moins important élément de base, le libellé, ou &laquo;&nbsp;tag&nbsp;&raquo;. Il s'agit de mots-clés définis par l'utilsateur ou l'utilisatrice - vous! - qui décrivent des caractéristiques distinctives d'un objet, le plus souvent au niveau de son contenu, et permettent ainsi de classer la source. Nous le verrons plus en détail par la suite, les tags sont des moyens d'[indexation personnelle](https://fr.wikipedia.org/wiki/Folksonomie) des objets que nous créons dans Tropy. Cette indexation peut être thématique (par exemple, le nom d'une personnalité politique qui apparaît dans plusieurs documents du projet) ou fonctionnelle (par exemple, *à transcrire*, pour les documents du projet dont nous souhaitons insérer une transcription en note). En tout cas, elle doit convenir à son créateur ou créatrice - toujours vous! - et être systématique et cohérente. Bien indexer les sources au moment de les enregistrer peut parfois être jugé chronophage. En réalité, c'est du temps bien investi et pleinement récupéré lors de l'analyse et de la rédaction. L'indexation facilite l'accès, de manière transversale, à des sources qui peuvent faire partie de différentes listes mais être réorganisées suivant une ou plus de caractéristiques communes. 
