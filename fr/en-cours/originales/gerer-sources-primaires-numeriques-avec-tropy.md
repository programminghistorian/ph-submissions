...
Admettant que vous avez lancé Tropy, créé un projet et être à présent devant la zone d'affichage en mode projet, comme décrit dans la section précédente. Il est possible d'importer les fichiers images de deux façons&nbsp;:
