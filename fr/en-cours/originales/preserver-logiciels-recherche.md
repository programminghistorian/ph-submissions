...
{% include figure.html filename="fr-or-preserver-logiciels-recherche-04.png" alt="Visual description of figure image" caption="Figure 4 : Capture d'écran de la version archivée du *package* Emacs `citar`." %}
...
{% include figure.html filename="citar_GitHub.png" alt="Visual description of figure image" caption="Figure 5 : Capture d'écran du dépôt GitHub du *package* Emacs `citar`. Le plug-in de navigateur Software Heritage fournit des informations dans l'infobulle à droite." %}
...
{% include figure.html filename="fr-or-preserver-logiciels-recherche-06.png" alt="Visual description of figure image" caption="Figure 6 : Créer un nouveau projet dans l'interface de GitLab.com." %}
...
{% include figure.html filename="fr-or-preserver-logiciels-recherche-07.gif" alt="Visual description of figure image" caption="Figure 7 : Ajout du fichier `leap.sh` dans votre dépôt." %}
...
{% include figure.html filename="fr-or-preserver-logiciels-recherche-08.gif" alt="Visual description of figure image" caption="Figure 8 : Ajout d'une licence." %}
...
{% include figure.html filename="fr-or-preserver-logiciels-recherche-11.gif" alt="Visual description of figure image" caption="Figure 11 : Créer un fichier CodeMeta." %}
...
{% include figure.html filename="fr-or-preserver-logiciels-recherche-12.gif" alt="Visual description of figure image" caption="Figure 12 : Ajouter le fichier CodeMeta à votre dépôt." %}
