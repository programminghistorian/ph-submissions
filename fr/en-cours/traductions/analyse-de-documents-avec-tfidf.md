...
Note du traducteur&#x202F;: la leçon intitulée [&laquo;&#x202F;Introduction à la stylométrie en Python&#x202F;&raquo;](/fr/lecons/introduction-a-la-stylometrie-avec-python) présente une application de ce genre de calculs.
</div>    
...
[^7]: Ben Schmidt, «&nbsp;Do Digital Humanists Need to Understand Algorithms?&nbsp;», _Debates in the Digital Humanities 2016_. Édition en ligne. Minneapois: University of Minnesota Press. [http://dhdebates.gc.cuny.edu/debates/text/99](https://perma.cc/95WD-SDM5).
...
[^13]: Marina Bondi et Mike Scott, eds. _Keyness in Texts_. (Philadelphie: John Benjamins, 2010).
