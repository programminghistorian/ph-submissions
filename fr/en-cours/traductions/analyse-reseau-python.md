...
- à utiliser le module [NetworkX](https://networkx.github.io/documentation/stable/index.html) pour traiter des données relationnelles avec [Python](https://programminghistorian.org/fr/lecons/introduction-et-installation) et
...
[^4]: Le module csv permet d'importer des données tabulaires stockées dans ce format. Il s'agit d'une des options possibles pour importer des données de ce type.
...
[^9]: Nous prenons la longueur de la liste moins un car nous voulons connaitre le nombre de liens (ou d'étapes) entre les sommets et non le nombre de sommets.
