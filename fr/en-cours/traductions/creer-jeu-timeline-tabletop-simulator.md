...
Cela étant, il se peut que vous soyez intéressé, pour la création de prototypes de cartes, par nanDECK, un outil couramment utilisé par les personnes qui créent des jeux, qu’elles soient amatrices ou professionnelles — c’est le cas notamment d’Elizabeth Hargrave.[^15]
