...
Tout comme les auteurs et autrices ou les maisons d'édition utilisent des traitements de texte pour créer des livres imprimés, les personnes qui conçoivent de jeux utilisent régulièrement des outils numériques pour réaliser des prototypes papier de leurs créations. Ce tutoriel vous présentera deux de ces outils numériques spécialisés : nanDECK d'Andrea Nini et Tabletop Simulator.

En tant qu'enseignant ou enseignante, vous aurez l'occasion d'attirer l'attention des élèves sur les différentes possibilités offertes par les versions papier et numériques d'un même objet informationnel. Grâce à la possibilité de jouer au même jeu à la fois physiquement et de façon dématérialisée, les élèves pourront réfléchir à la manière dont le support influence l'expérience de jeu. Grâce à leur nouvelle capacité à modifier les éléments ou les pièces d’un jeu familier, les élèves pourront explorer ce qui se passe lorsque les règles d’un jeu bien connu sont modifiées[^4].
...
> **Timeline** est un jeu de cartes où chaque carte représente un événement historique, une invention ou une découverte spécifique, mais où seule une face indique l'année au cours de laquelle cet événement a eu lieu. À tour de rôle, les personnes participantes placent une carte de leur main dans la rangée de cartes sur la table. Une fois la carte posée, la personne qui l'a placée la retourne pour révéler la date au verso. Si la carte a été placée dans l'ordre chronologique par rapport à toutes les autres cartes sur la table, elle reste en place ; sinon, la carte est retirée du jeu et le personne concernée prend une autre carte de la pioche. Le première personne à s'être débarrassée de toutes ses cartes en les plaçant correctement a gagné.[^8]
