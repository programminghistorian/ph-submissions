...
{% include figure.html filename="demarrer-avec-omeka-05.png" alt="DESCRIPTION VISUELLE DE L'IMAGE" caption="Page permettant de paramétrer le thème" %}
...
{% include figure.html filename="demarrer-avec-omeka-07.png" alt="DESCRIPTION VISUELLE DE L'IMAGE" caption="Page des plugins" %}
...
{% include figure.html filename="demarrer-avec-omeka-08.png" alt="DESCRIPTION VISUELLE DE L'IMAGE" caption="Ajouter un contenu" %}

Cliquez sur **Items** (*Contenus*) à gauche du menu, puis sur **Add an item** (*Ajouter un contenu*).

## Décrire un contenu

{% include figure.html filename="demarrer-avec-omeka-09.png" alt="DESCRIPTION VISUELLE DE L'IMAGE" caption="Rendez votre contenu public en utilisant la case à cocher entourée sur l’image" %}
...
{% include figure.html filename="demarrer-avec-omeka-11.png" alt="DESCRIPTION VISUELLE DE L'IMAGE" caption="Ajouter des fichiers à un contenu" %}
...
{% include figure.html filename="demarrer-avec-omeka-12.png" alt="DESCRIPTION VISUELLE DE L'IMAGE" caption="Parcourir les contenus (Vue administrateur)" %}
...
{% include figure.html filename="demarrer-avec-omeka-13.png" alt="DESCRIPTION VISUELLE DE L'IMAGE" caption="Affichage du contenu (Vue administrateur)" %}
...
{% include figure.html filename="demarrer-avec-omeka-14.png" alt="DESCRIPTION VISUELLE DE L'IMAGE" caption="Affichage du contenu (Vue publique)" %}

Voici ce que vos utilisateurs verront lorsqu’ils consulteront votre page.

## Créer une collection

{% include figure.html filename="demarrer-avec-omeka-15.png" alt="DESCRIPTION VISUELLE DE L'IMAGE" caption="Ajouter une collection" %}
...
{% include figure.html filename="demarrer-avec-omeka-16.png" alt="DESCRIPTION VISUELLE DE L'IMAGE" caption="Ajouter des métadonnées à la collection" %}
...
{% include figure.html filename="demarrer-avec-omeka-17.png" alt="DESCRIPTION VISUELLE DE L'IMAGE" caption="Cliquez sur les cases à cocher des contenus à éditer par lot" %}
...
{% include figure.html filename="demarrer-avec-omeka-18.png" alt="DESCRIPTION VISUELLE DE L'IMAGE" caption="Sélectionner une collection dans la liste déroulante" %}
...
{% include figure.html filename="demarrer-avec-omeka-19.png" alt="DESCRIPTION VISUELLE DE L'IMAGE" caption="Parcourir les collections (Vue publique)" %}
