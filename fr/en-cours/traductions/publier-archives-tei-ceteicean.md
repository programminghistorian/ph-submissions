...
Mise à jour de mars 2025 : La version originale en espagnol a utilisé l'éditeur <em>Atom</em> ; cependant nous ne recommandons pas d'utiliser Atom, car le logiciel n'a pas reçu de maintenance ni de mises à jour depuis sa fermeture en décembre 2022. Nous avons alors décidé d'utiliser <em>VS Code</em> de la même manière, à condition d'installer également l'extension <em>HTML Preview</em> depuis l'onglet Extensions.
</div>
