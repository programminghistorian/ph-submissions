...
**_Clusters_ :** Cette vue vous montre les mots qui apparaissent souvent ensemble.
**_Collocates_ :** Les clusters nous montrent des mots qui apparaissent _définitivement _ ensemble dans un corpus ; les collocations (_collocates_) montrent des mots qui sont statistiquement susceptibles d'apparaître ensemble. 
...
Que voyez-vous ? Je comprends que cela peut être difficille d'identifier des schémas. Essayez d'appuyer sur le bouton jaune "_sort_". Que se passe-t-il maintenant ?
...
En France, des outils similaires à AntConc ont dévéloppées par la textométrie et la logométrie, souvent par des historien-ne-s. On peut nommer notamment [Hyperbase](http://ancilla.unice.fr/), [Iramuteq](http://iramuteq.org/), [Lexico](http://www.lexi-co.com/) ou [TXM](http://textometrie.ens-lyon.fr/?lang=fr). 
