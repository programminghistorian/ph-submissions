...
De leur côté, les catalogues d’archives utilisent souvent des URL structurés avec un seul élément de données. La British Cartoon Archive structure ses archives en ligne en utilisant le format :
