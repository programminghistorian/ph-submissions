...
To begin, you'll need to import the Pandas and SciPy libraries that you acquired in the Setup and Installation section above. Create a new blank file in your text editor of choice, and name it `similarity.py`. (You can also download my [complete version of this script]({{ site.baseurl }}/assets/common-similarity-measures/similarity.py).) At the top of the file type:
