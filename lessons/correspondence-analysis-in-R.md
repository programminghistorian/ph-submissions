...
Because CA visualizes relationships between elements of your data as distances on a plot, one can often discover broad themes based on what elements in one category appear near elements in the other. Thus, CA can be a good first step to filter through the main themes of a large data set.  It is a powerful tool to understand historical information inside digital collections particularly.
