...
{% include figure.html src="../images/Sonnets-topic-words.png" caption="Table of top 6 words in 10 topics" %}
...
{% include figure.html src="../images/Sonnets-topic-probabilitie.png" caption="Table of topic probabilities" %}
...
{% include figure.html src="../images/oyant-word-cloud.png" caption="Word cloud produced through word count" %}

Compare this to this word cloud, produced in R via LDA: 

{% include figure.html src="../images/R-word-cloud.png" caption="Word cloud produced through probability" %}
...
{% include figure.html src="../images/Voyant-word-cloud.png" caption="Word cloud produced through word count" %}
