...
1. Identify the output (word cloud or table) and process (how is the output produced?)
2. Identify input (know the corpus and its limits)
3. Identify research question (evaluate *why* you need topic models, as opposed to another digital method; a related question is what a scholar is trying to demonstrate with topic models)
...
If you are looking at a word cloud it could have been produced using either **probabilistic** or **word count** methods. It is important to know which is which, because each measure different things, and yet can look very similar. 
...
If you are someone with average vision, you might notice that your eye is drawn to the words "show," "sweet," and "make," which might suggest a pattern. However, there is no connection between these words; they are different sizes, which means they have different counts. And because this is based on *word count*, their presence in the same cloud does not indicate the same proportional relationship that a probabilistic word cloud would. 
