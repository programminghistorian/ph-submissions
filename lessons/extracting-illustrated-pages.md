...
This lesson's software requirements are minimal, other than having a machine that runs a relatively recent edition (either 32 or 64-bit) of the standard operating systems. Miniconda is available for Windows, macOS (previously Mac OS X), and Linux.
...
- Internet Archive Python Library (no version listed) [maintained by IA employee and likely wrapping the [Version 1 Search API](https://archive.org/services/search/beta/)
