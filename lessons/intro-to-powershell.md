...
{% include figure.html src="../images/intro-to-powershell1.png" caption="PowerShell on start up" %}
...
{% include figure.html src="../images/intro-to-powershell2.png" caption="Listing directory contents with `Get-ChildItem`" %}
...
{% include figure.html src="../images/intro-to-powershell3.png" caption="An error caused by jumping between branches" %}
...
{% include figure.html src="../images/intro-to-powershell4.png" caption="Moving, copying, and deleting" %}
...
{% include figure.html src="../images/intro-to-powershell5.png" caption="The difference between '>' and `>>`" %}
...
We could look at each one individually. You should be able to guess that you might be able to display all four with one command, though. Enter 
...
{% include figure.html src="../images/intro-to-powershell6.png" caption="Help page for `Get-Content`" %}
...
{% include figure.html src="../images/intro-to-powershell7.png" caption="The online help page for `Get-Content`" %}
