...
{% include figure.html src="../sonification-supporting-materials/musicalgorithms-main-site.png" caption="The Musicalgorithms Website as it appeared on February 2nd, 2016" %}
...
3. Go to the [Musicalgorithms](http://musicalgorithms.org/) site, and hit the load button. In the pop-up, click the blue 'load' button and select the file saved in step 2. The site will load your materials and display a green check mark if it loaded successfully. If it did not, make sure that your values are separated by spaces, and that they follow immediately the last comma in the code block in step 2. You may also try loading up the [demo file for this tutorial](/sonification-supporting-materials/romancoin-data-music.csv) instead. {% include figure.html src="../sonification-supporting-materials/musicalgorithms-upload.png" caption="Click 'load' on the main screen to get this dialogue box. Then 'load csv'. Select your file; it will appear in the box. Then click the bottom load button." %}
...
You have now sonified one column of data! Click on the 'save' button, then 'save csv'. {% include figure.html src="../sonification-supporting-materials/musicalgorithms-save.png" caption="The save data dialogue box." %}You'll have a file that looks something like this:
...
Drucker, Johanna. 2011. Humanities Approaches to Graphical Display. DHQ 5.1 [http://www.digitalhumanities.org/dhq/vol/5/1/000091/000091.html](http://www.digitalhumanities.org/dhq/vol/5/1/000091/000091.html)
