...
**a screenshot here to just show the different tabs mentioned below would help**
...
**could you give a quick example using LMMS, here, Shawn - I'm a bit confused**
...
**Can you flesh out a bit more how MIDITime is distinctive to the previous software package? Why might one want to use it over the tool they just used previously?**
...
The values after MIDITime set the beats per minute, the output file, the number of seconds to represent a year in the music, the base octave (middle C is conventionally represented as C5, so here 4 represents one octave below middle C), and how many octaves to map the pitches against. Now we define our data: **I think this might need to be explained a bit more - step by step, explain each value. I'm a bit confused right now.**
...
**again, a bit more about what Sonic Pi offers that the previous two don't - how they fit together. you hint at it but I'm a tiny bit unclear so far*
