...
date: YYYY-MM-DD
authors:
- Eric Francis Mendonça de Castro Maia
reviewers:
- Forename Surname
- Forename Surname
editors:
...
No desenvolvimento da pesquisa sobre os Cartazes da Democracia, em minha dissertação de mestrado, que possui o título “Cartazes da democracia: imagem, política e ação coletiva no Brasil Republicano”, o uso do Tropy produziu ganhos metodológicos decisivos para a reunião do corpus, para o tratamento documental e para o próprio amadurecimento das perguntas de pesquisa. Ao trabalhar com o meu conjunto documental, tornou-se evidente que a organização sistemática das fontes constituía uma etapa central da investigação. O Tropy ofereceu as condições para reunir, ordenar e recuperar este conjunto relativamente extenso, heterogêneo em suas características materiais e denso em termos históricos e políticos. Em vez de manter as imagens dispersas em pastas, arquivos soltos e anotações paralelas, o software permitiu construir um ambiente de trabalho unificado, no qual cada cartaz passou a ser tratado como item singular, mas também como parte de uma série documental passível de comparação.

Um primeiro ganho metodológico esteve na padronização descritiva das fontes.

Ao registrar de forma consistente informações como título, data, instituição produtora, coleção de pertencimento e características gerais do documento, foi possível estabelecer uma base mais sólida para a identificação e a recuperação dos itens. Em uma pesquisa com cartazes políticos, essa padronização teve especial relevância porque muitos documentos circulavam originalmente fora de circuitos arquivísticos convencionais e, por isso, carregavam lacunas, ambiguidades ou informações incompletas. A descrição sistemática favoreceu, assim, a estabilização mínima do corpus, permitindo que os cartazes fossem analisados com maior rigor e que suas informações fossem recuperadas posteriormente sem depender apenas da memória do pesquisador ou da nomeação irregular dos arquivos digitais.

Entre os aspectos mais importantes dessa experiência esteve a possibilidade de criar metadados personalizados, ajustados às demandas específicas da pesquisa. No caso dos cartazes, os campos genéricos disponíveis em muitos softwares de organização de imagens seriam insuficientes para dar conta de elementos fundamentais da análise. Foi necessário registrar dimensões, tipo e gramatura do papel, técnica de impressão, estado de conservação, marcas de uso, indícios de circulação, nome da entidade responsável pela produção e, quando possível, autoria artística ou fotográfica. Esses metadados funcionaram como instrumentos heurísticos, pois permitiram formular relações entre materialidade, circulação e usos políticos dos cartazes. A qualidade do papel, por exemplo, poderia sugerir diferentes níveis de investimento econômico; furos, fitas adesivas e marcas de dobra indicavam formas de exposição ou transporte; carimbos postais revelavam circuitos de envio e difusão. O trabalho com metadados personalizados, portanto, integrou diretamente a organização documental à interpretação histórica.

Desse modo, o Tropy favoreceu uma integração efetiva entre organização e análise. Em vez de tratar o momento da catalogação como fase preliminar e meramente instrumental, a pesquisa mostrou que a descrição cuidadosa das fontes já constituía uma forma de produção de conhecimento. Ao preencher campos, atribuir categorias, escrever notas e comparar itens, foi possível identificar e perceber regularidades, diferenças e problemas que talvez permanecessem invisíveis em uma organização física ou insuficiente, do ponto de vista informacional. No caso dos cartazes, isso significou reconhecer relações entre repertórios visuais, estratégias de comunicação e culturas políticas de diferentes movimentos sociais. A própria estruturação dos dados ajudou a evidenciar como determinadas pautas apareciam com maior frequência, como certas soluções gráficas se repetiam e como a produção material dos cartazes podia variar segundo o tipo de organização envolvida.

Outro ganho importante esteve na maior capacidade de comparação entre documentos. Uma vez descritos e organizados em um mesmo ambiente, os cartazes puderam ser examinados de forma relacional, e não como peças isoladas. Essa comparação tornou possível identificar recorrências temáticas, padrões visuais, escolhas de linguagem, diferenças materiais e variações na forma de construir a mensagem política. Em um corpus vinculado à Assembleia Nacional Constituinte e à participação da sociedade civil, essa possibilidade foi especialmente relevante para compreender o modo como diferentes movimentos formulavam suas reivindicações e disputavam visibilidade pública. O Tropy, ao facilitar a circulação entre itens e ao reunir em uma única interface informações descritivas e visuais, contribuiu para transformar um conjunto de imagens em uma série de fontes mais inteligível.

Essa dinâmica esteve ligada também à construção de categorias de classificação mais refinadas. O uso de etiquetas, listas e campos específicos permitiu agrupar os cartazes segundo temas, instituições, temporalidades, formas de circulação e aspectos materiais. Isso contribuiu para a formulação de categorias capazes de dialogar com os problemas da pesquisa. No caso do mestrado, tal procedimento foi fundamental para distinguir, por exemplo, cartazes ligados a movimentos de mulheres, sindicatos, pautas agrárias, direitos indígenas, movimento negro e outras frentes de atuação política presentes no processo de redemocratização. Foi possível extrair da classificação perguntas metodológicas mais sofisticadas e profundas, já que a definição das categorias exigia escolhas interpretativas e revelava, por si mesma, as formas de estruturação do corpus.

A possibilidade de registrar notas descritivas e analíticas de forma cumulativa constituiu outro aspecto metodologicamente fértil. Ao associar observações diretamente a cada item, o Tropy permitiu preservar hipóteses, dúvidas, relações entre documentos e comentários sobre materialidade e conteúdo visual. Em pesquisas com imagens, esse recurso é particularmente importante porque muitos elementos significativos não se esgotam nos campos formais de descrição. No caso dos cartazes pesquisados, as notas possibilitaram registrar detalhes como o uso de determinadas cores, a presença de símbolos recorrentes, o diálogo com repertórios gráficos de outras campanhas e a relação entre texto e imagem. Com isso, o software funcionou também como espaço de sedimentação progressiva da leitura histórica, permitindo que as interpretações fossem acumuladas e revisitadas no decorrer da pesquisa.

Um ganho especialmente relevante para esse corpus esteve na atenção à materialidade das fontes. A função do cartazes analisados não se restringia à de meros suportes gráficos de mensagens políticas, mas constituíam objetos históricos marcados por usos concretos, deslocamentos, formas de guarda e condições específicas de produção. A possibilidade de registrar no Tropy informações sobre dimensão, papel, gramatura, técnica de impressão, furos, fitas adesivas, rasgos, dobras e carimbos ampliou muito o alcance da análise. Esses elementos ajudaram a distinguir cartazes que haviam sido efetivamente afixados daqueles que provavelmente permaneceram guardados, bem como permitiram levantar hipóteses sobre seus modos de circulação. Em alguns casos, a presença de marcas postais confirmou que o envio pelos Correios fazia parte do universo de difusão desses impressos políticos. A descrição material, portanto, contribuiu para reconstruir práticas históricas de produção, distribuição e uso.

Associado a isso, o Tropy fortaleceu a rastreabilidade das informações. Cada imagem pôde permanecer vinculada à referência documental e ao contexto de pesquisa em que foi analisada. Essa rastreabilidade é fundamental, pois garante a possibilidade de conferir a procedência do documento, retornar ao item original e explicitar os caminhos percorridos pelo pesquisador. Em um conjunto como o do Centro Pró-Memória da Constituinte, essa dimensão foi particularmente importante, já que o valor analítico dos cartazes está também relacionado ao fato de integrarem uma coleção preservada institucionalmente, cuja trajetória arquivística influencia sua leitura.

A ferramenta também trouxe ganhos evidentes no que diz respeito à recuperação rápida de documentos específicos. Uma vez estruturado o corpus com metadados, etiquetas e notas, tornou-se muito mais simples localizar cartazes por tema, produtor, elemento material ou característica visual. Em vez de depender de pastas nomeadas de modo precário ou da lembrança de onde determinado arquivo havia sido salvo, passei a recuperar os documentos a partir de critérios historicamente significativos. Isso teve impacto direto na escrita, na preparação de apresentações, na revisão do corpus e na construção dos capítulos da dissertação.

Outro aspecto metodologicamente relevante esteve na gestão de documentos compostos por múltiplas imagens. Embora os cartazes sejam, em muitos casos, itens singulares, o trabalho com fontes digitais frequentemente envolve fotografias de detalhes, versos, marcas específicas ou diferentes estados de conservação do mesmo documento.

A possibilidade de reunir múltiplas imagens em uma mesma entrada do Tropy contribuiu para manter a unidade e a inteligibilidade do item documental sem perder de vista a riqueza de suas variações visuais. Esse recurso é valioso para pesquisadores que precisam articular visão geral e leitura minuciosa da fonte.

O software também favoreceu a construção de séries documentais. No decorrer do trabalho, os cartazes deixaram de ser vistos como peças avulsas e passaram a constituir séries organizadas segundo critérios temáticos, materiais e políticos. Essa transformação foi metodologicamente decisiva porque permitiu pensar a coleção em termos de conjunto, identificando continuidades, deslocamentos e contrastes internos. Em uma pesquisa sobre cultura visual e ação coletiva, essa passagem de itens isolados a séries documentais foi uma condição para compreender a historicidade dos cartazes e sua inserção em processos mais amplos de mobilização social.

Além disso, o Tropy ampliou o controle sobre o fluxo de trabalho da pesquisa. Foi possível acompanhar quais cartazes já haviam sido descritos, quais ainda careciam de informações adicionais, quais exigiam revisão e quais estavam associados a determinadas hipóteses analíticas. Essa gestão mais clara do processo evitou retrabalho, reduziu perdas de informação e contribuiu para uma rotina de pesquisa mais estável. Em investigações que lidam com grande quantidade de imagens, essa dimensão organizacional tem impacto direto na qualidade da análise.

Outro ganho importante esteve na produção de dados reaproveitáveis. Os metadados e classificações construídos no decorrer da pesquisa puderam ser mobilizados em diferentes momentos, desde a redação da dissertação até a elaboração de comunicações em eventos, tabelas analíticas e futuras possibilidades de disponibilização pública do corpus. O trabalho realizado no Tropy não se esgotou, portanto, em uma organização interna do acervo, mas produziu informações que podem sustentar novos usos acadêmicos, curadorias, catálogos e iniciativas de compartilhamento estruturado.

Um desses resultados será a doação do meu próprio arquivo pessoal do Tropy para uso no computador do Museu da República, onde novas pesquisas poderão ser desenvolvidas a partir dos ganhos organizacionais que pude construir.

Esse ponto se conecta à facilidade de exportação e interoperabilidade oferecida pelo software. Ao permitir a exportação de coleções e dados, o Tropy favorece a circulação do conhecimento produzido sobre as fontes e cria condições para articulação com outros ambientes de pesquisa. Para um trabalho com cartazes políticos preservados em instituição pública, essa possibilidade é especialmente promissora, pois dialoga com práticas de transparência metodológica, preservação da informação e abertura de caminhos para novas investigações.

Por fim, talvez um dos resultados mais importantes tenha sido a abertura para novas perguntas de pesquisa. À medida que o corpus foi sendo descrito e estruturado, surgiram questões que dificilmente teriam emergido em um ambiente de organização improvisado, como por exemplo, questões estatísticas de aparecimento de cartazes. O número de cartazes de certas pautas, a ausência de outras pautas, como os direitos LGBTQIAPN+, levaram a novas perguntas sobre a sociedade brasileira no contexto da Redemocratização. A atenção às características materiais dos cartazes levou a hipóteses sobre financiamento e circulação. A classificação temática revelou concentrações e ausências que exigiam interpretação. A comparação entre documentos mostrou formas diversas de construir visibilidade política. Nesse sentido, o Tropy não serviu apenas para ordenar um conjunto de imagens. Ele contribuiu para qualificar a reflexão metodológica e para tornar mais explícitos os critérios de seleção, descrição e análise que sustentaram a pesquisa.

No caso dos Cartazes da Democracia, portanto, o uso do Tropy significou substituir uma lógica fragmentada de armazenamento por uma prática de organização documental articulada à investigação histórica. Isso fortaleceu a consistência metodológica do trabalho, ampliou a capacidade de leitura do corpus e tornou possível extrair das fontes um conjunto mais denso de informações sobre sua materialidade, circulação e função política. Em uma pesquisa histórica com imagens, esses ganhos não são acessórios. Eles incidem diretamente sobre a qualidade das perguntas formuladas, sobre a consistência da análise e sobre a própria produção do conhecimento.
...
Nessa perspectiva, o estudo de caso apresentado demonstra que ferramentas digitais concebidas para o tratamento de fontes visuais podem ampliar de modo substancial a densidade analítica da investigação, sobretudo quando se trabalha com acervos extensos e heterogêneos. Ao favorecer a rastreabilidade das informações, a interoperabilidade dos dados e a produção de séries documentais comparáveis, o Tropy contribui para deslocar a pesquisa com imagens de uma lógica fragmentária e improvisada para um regime de trabalho mais reflexivo, explícito e metodologicamente em convergência com padrões acadêmicos da História Digital. Os ganhos decorrentes não se restringem ao plano operacional, afetando a qualidade da descrição, a consistência da análise e a capacidade de formular novas perguntas sobre o corpus, como se observa na atenção às formas de circulação dos cartazes, às condições materiais de sua produção, às hierarquias de visibilidade entre pautas e à historicidade de seus repertórios visuais. Desse modo, a experiência aqui discutida sugere que o tratamento digital das fontes visuais, quando conduzido com critérios padronizados e claros, pode se converter em um espaço privilegiado de articulação entre técnica, método e interpretação, reforçando a centralidade da organização documental na construção do conhecimento histórico.
