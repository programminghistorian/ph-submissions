...
{% include figure.html filename="tr-pt-introducao-jupyter-notebooks-1.png" alt="Visual description of figure image" caption="Figura 1. Caption text to display" %}
...
## Conclusão[conclusao](/pt/lessons/introducao-jupyter-notebooks#conclusao)
