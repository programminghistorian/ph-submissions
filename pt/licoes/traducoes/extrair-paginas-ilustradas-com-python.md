...
Aqui estão as miniaturas de página dum volume do HathiTrust com o identificador exclusivo `osu.32435078698222`. Após o processo descrito nesta lição, fez-se o *download* apenas das páginas com imagens (31 no total) como JPEGs para uma pasta.
...
Nota de tradução: Para instalar as dependências, altere o seu diretório de trabalho para a pasta onde se encontra instalado o Python executando o comando `cd` e, depois, execute o comando `pip install` ou `pip3 install` seguido de:
